...
import type { CodeNodeRendererProps } from '../../../types/index.ts'
import { createCodeRendererModel } from '@stream-markdown/core'
import { computed, defineAsyncComponent } from 'vue'
import { useContext, useShiki } from '../../../composables/index.ts'
...
<template>
    ...
    <component :is="component" v-else v-bind="props" :class="[languageClass]" />
</template>
