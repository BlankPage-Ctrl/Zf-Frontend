...
import type { ListItemNodeRendererProps } from '../../types/index.ts'
...
<template>
    <li data-stream-markdown="list-item" class="py-1 pl-1 [&_p]:m-0">
        <p v-if="isTaskListItem" data-stream-markdown="task-list-item" class="[&_p]:inline-block">
            <input
