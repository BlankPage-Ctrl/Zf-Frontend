...
import { useContext, useControls, useI18n } from '../../composables/index.ts'
import NodeList from '../node-list.vue'

const props = withDefaults(defineProps<TableNodeRendererProps>(), {})

const { beforeDownload, controls: controlsConfig, onCopied, uiComponents: UI } = useContext()
...
<template>
    <div data-stream-markdown="table-wrapper" class="my-4 flex flex-col gap-2 items-center">
        ...
        <div data-stream-markdown="table-inner-wrapper" class="w-full overflow-x-auto">
            <component
                :is="UI.Table"
                ref="tableRef"
                :headers="headerCells"
