...
import type { TextNodeRendererProps } from '../../types/index.ts'
import { createTextModel } from '@stream-markdown/core'
import { computed } from 'vue'
import { useContext } from '../../composables/index.ts'
...
<template>
    ...
    <span v-else data-stream-markdown="text" class="whitespace-pre-wrap break-words">
