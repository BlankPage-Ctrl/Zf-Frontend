...
if (props.options.length && !modelValue.value) modelValue.value = String(props.options[0]!.value)
...
<template>
    <div data-stream-markdown="segmented" class="p-0.5 rounded-md flex gap-1 items-center">
        <component
            :is="UI.Button"
