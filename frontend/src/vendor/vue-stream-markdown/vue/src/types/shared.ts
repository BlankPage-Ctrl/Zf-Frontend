...
export type TableControlsConfig = CoreTableControlsConfig<
...
export type ImageControlsConfig = CoreImageControlsConfig<
    ControlTransformer<ImageNodeRendererProps>
>

export type MermaidControlsConfig = CoreMermaidControlsConfig<
