...
export const fileHandlers = [
  ...
  http.get('/workspaces/:workspaceId/files/events', () => {
    ...
    const eventTemplates = [
      {
        type: 'MODIFIED',
        extra: (n: FileTreeNode) => ({ node: { id: n.id, name: n.name, path: n.path, type: n.type, isDirectory: false, size: n.size, lastModified: Date.now() } }),
      },
      {
        type: 'CREATED',
      ...
      {
        type: 'DELETED',
        extra: (n: FileTreeNode) => ({ node: { id: n.id, name: n.name, path: n.path, type: n.type, isDirectory: false } }),
      },
      {
        type: 'MOVED',
        extra: (n: FileTreeNode) => {
          ...
          return {
            node: { id: n.id, name: newName, path: n.path.replace(n.name, newName), type: n.type, isDirectory: false, size: n.size },
            oldPath: n.path,
          }
        },
      },
