...
import type { ImagePreviewControlKey, ImagePreviewTransformState } from '@stream-markdown/core'
...
const imageList = computed(() =>
    createImagePreviewSources(parsedNodes.value, props.transformHardenUrl),
)
const {
    state: imageSrc,
    prev,
