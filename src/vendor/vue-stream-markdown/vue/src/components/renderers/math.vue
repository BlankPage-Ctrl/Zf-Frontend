...
const { cdnOptions, katexOptions, uiComponents: UI } = useContext()
...
<template>
    <component :is="Error" v-if="error" variant="katex" :message="errorMessage" />
    <div v-else data-stream-markdown="math" class="my-4 text-center" v-html="html" />
</template>
